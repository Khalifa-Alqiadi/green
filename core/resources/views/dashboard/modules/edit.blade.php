                    ...
                    <div class="box-body p-a-2">
                        <form method="POST" action="{{ route("WebmasterSectionsUpdate",$WebmasterSections->id) }}" class="dashboard-form" enctype="multipart/form-data">
                            ...
                            <div id="fields_settings" class="{{ ($WebmasterSections->type==10)?"displayNone":"" }}">
                                ...
                                <div class="form-group row">
                                    <label for="authors_status1" class="col-sm-2 form-control-label">الكتاب / Authors</label>
                                    <div class="col-sm-10">
                                        <div class="radio">
                                            <label class="md-check">
                                                <input type="radio" name="authors_status" value="1" class="has-value" {{ ($WebmasterSections->authors_status==1) ? "checked" : "" }} id="authors_status1">
                                                <i class="primary"></i>
                                                {{ __('backend.yes') }}
                                            </label>
                                            &nbsp; &nbsp;
                                            <label class="md-check">
                                                <input type="radio" name="authors_status" value="0" class="has-value" {{ ($WebmasterSections->authors_status==0) ? "checked" : "" }} id="authors_status0">
                                                <i class="danger"></i>
                                                {{ __('backend.no') }}
                                            </label>
                                        </div>
