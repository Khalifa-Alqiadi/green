                    ...
                    <div id="fields_settings">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="radio">
                                    <label class="md-check">
                                        <input type="radio" name="authors_status" value="1" class="has-value" id="authors_status1">
                                        <i class="primary"></i>
                                        {{ __('backend.yes') }}
                                    </label>
                                    &nbsp; &nbsp;
                                    <label class="md-check">
                                        <input type="radio" name="authors_status" value="0" class="has-value" checked id="authors_status0">
                                        <i class="danger"></i>
                                        {{ __('backend.no') }}
                                    </label>
                                </div>
