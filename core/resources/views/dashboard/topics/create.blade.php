        ...
        <div class="box">
            ...
            <div class="box nav-active-border b-primary lig">
                ...
                <div class="box-body b-t p-a-2">
                    <form method="POST" action="{{ route('topicsStore', $WebmasterSection->id) }}" class="dashboard-form"
                                    ...
                                    <div class="form-group">
                                        <div class='input-group date' ui-jp="datetimepicker"
                                            ...
                                            <input type="text" name="date" id="date" class="form-control"
                                                value="{{ Helper::formatDate(date('Y-m-d')) }}" placeholder=""
                        ...
                        @else
                            <input type="hidden" name="date" id="date" class="form-control"
                                value="{{ Helper::formatDate(date('Y-m-d')) }}">
                        @endif
                                    ...
                                    <div class="form-group">
                                        <div class='input-group date' ui-jp="datetimepicker"
                                            ...
                                            <input type="text" name="expire_date" id="expire_date" class="form-control"
                                                value="" placeholder="" maxlength="191" autocomplete="off">
                                            <span class="input-group-addon">
                                                <span class="fa fa-calendar"></span>
                                            </span>
                                        </div>
                                        ...
                                        @foreach ($fatherSections as $fatherSection)
                                            ...
                                            @foreach ($fatherSection->fatherSections as $subFatherSection)
                                                ...
                                                @foreach ($subFatherSection->fatherSections as $sub2FatherSection)
                                                    ...
                                                    ?>
                                                    <option value="{{ $sub2FatherSection->id }}"> {!! $ftitle !!}
                                                        {!! $t_arrow !!} {!! $title !!}
                        ...
                        @else
                            <input type="hidden" name="section_id" id="cat_ids" value="0" ui-jp="select2"
                                ui-options="{theme: 'bootstrap'}">
                        @endif

                        @if ($WebmasterSection->authors_status)
                            <div class="form-group row">
                                <label for="authors" class="col-sm-2 form-control-label">{!! __('backend.author') !!}</label>
                                <div class="col-sm-10">
                                    <select name="authors[]" id="authors" class="form-control select2-multiple"
                                        multiple ui-jp="select2" ui-options="{theme: 'bootstrap'}">
                                        @foreach ($AuthorsList as $Author)
                                            <option value="{{ $Author->id }}">
                                                {{ $Author->name_ar }}{{ $Author->name_en ? ' / ' . $Author->name_en : '' }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                        ...
                        @else
                            <input type="hidden" name="authors[]" id="authors" value="0" ui-jp="select2"
                                ui-options="{theme: 'bootstrap'}">
                        @endif
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" autocomplete="off"
                                                ...
                                                id="title_{{ @$ActiveLanguage->code }}" value="" required
                                                ...
                                                @if (Helper::GeneralWebmasterSettings('text_editor') == 2)
                                                    <div>
                                                        <textarea name="details_{{ @$ActiveLanguage->code }}" id="details_{{ @$ActiveLanguage->code }}"
                                                            class="form-control ckeditor" dir="{{ @$ActiveLanguage->direction }}"><div dir="{{ @$ActiveLanguage->direction }}"><br></div></textarea>
                                                    </div>
                                                @elseif (Helper::GeneralWebmasterSettings('text_editor') == 1)
                                                    <div>
                                                        <textarea name="details_{{ @$ActiveLanguage->code }}" id="details_{{ @$ActiveLanguage->code }}"
                                                            class="form-control tinymce" dir="{{ @$ActiveLanguage->direction }}"><div dir="{{ @$ActiveLanguage->direction }}"><br></div></textarea>
                                                    </div>
                                                @else
                                                    <div class="box p-a-xs">
                                                        <textarea name="details_{{ @$ActiveLanguage->code }}" id="details_{{ @$ActiveLanguage->code }}"
                                                            class="form-control summernote summernote_{{ @$ActiveLanguage->code }}" dir="{{ @$ActiveLanguage->direction }}"><div dir="{{ @$ActiveLanguage->direction }}"><br></div></textarea>
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
                                ...
                                @foreach (Helper::languagesList() as $ActiveLanguage)
                                    @if ($ActiveLanguage->box_status)
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea name="details_{{ @$ActiveLanguage->code }}" id="details_{{ @$ActiveLanguage->code }}"
                                                    class="form-control" dir="{{ @$ActiveLanguage->direction }}" rows="5"></textarea>
                                            </div>
                                        </div>
                                    @endif
                                @endforeach
                            ...
                            <div class="form-group row" id="youtube_link_div" style="display: none">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="youtube_link" id="youtube_link" class="form-control"
                                        value="" placeholder="'https://www.youtube.com/watch?v=JQs4QyKnYMQ"
                            ...
                            <div class="form-group row" id="vimeo_link_div" style="display: none">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="vimeo_link" id="vimeo_link" class="form-control"
                                        value="" placeholder="'https://vimeo.com/131766159" maxlength="191"
                        ...
                        @if ($WebmasterSection->tags_status)
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="tags" id="tags" class="form-control form-tags"
                                ...
                                <div class="col-sm-10">
                                    <select name="page_form_id" class="form-control c-select" id="page_form_id">
                                        ...
                                        @foreach ($GeneralWebmasterSections->where('type', 6) as $FWebmasterSection)
                                            <option value="{{ $FWebmasterSection->id }}">{!! $FWebmasterSection->{'title_' . @Helper::currentLanguage()->code} !!}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                    ...
                                    <div class="col-sm-10">
                                        <select name="popup_id" class="form-control c-select" id="popup_id">
                                            ...
                                            @foreach (\App\Models\Popup::where('status', 1)->get() as $PPopup)
                                                <option value="{{ $PPopup->id }}">{!! $PPopup->{'title_' . @Helper::currentLanguage()->code} !!}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                        ...
                        @if ($WebmasterSection->type == 10)
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <div class="radio m-t-sm">
                                        <label class="md-check">
                                            <input type="radio" name="hide_header" value="0" class="has-value"
                                                checked id="hide_header1">
                                            <i class="primary"></i>
                                            {{ __('backend.yes') }}
                                        </label>
                                        &nbsp; &nbsp;
                                        <label class="md-check">
                                            <input type="radio" name="hide_header" value="1" class="has-value"
                                                id="hide_header2">
                                            <i class="danger"></i>
                                            {{ __('backend.no') }}
                                        </label>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <div class="radio m-t-sm">
                                        <label class="md-check">
                                            <input type="radio" name="hide_footer" value="0" class="has-value"
                                                checked id="hide_footer1">
                                            <i class="primary"></i>
                                            {{ __('backend.yes') }}
                                        </label>
                                        &nbsp; &nbsp;
                                        <label class="md-check">
                                            <input type="radio" name="hide_footer" value="1" class="has-value"
                                                id="hide_footer2">
                                            <i class="danger"></i>
                                            {{ __('backend.no') }}
                                        </label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="radio m-t-sm">
                                            ...
                                            <label class="md-check">
                                                <input type="radio" name="status" value="1" class="has-value"
                                                    checked id="status1">
                                                <i class="primary"></i>
                                                {{ __('backend.active') }}
                                            </label>
                                            &nbsp; &nbsp;
                                            <label class="md-check">
                                                <input type="radio" name="status" value="0" class="has-value"
                                                    id="status2">
                                                <i class="danger"></i>
