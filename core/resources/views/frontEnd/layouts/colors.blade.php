...
<style>
    :root{
        ...
        --color-white: #fff;
        --meu-navy: {{$style_color2}};
        --meu-navy-2: {{ Helper::colorHexToDarken($style_color2, 1.2) }};
        --meu-navy-ink: {{ Helper::colorHexToDarken($style_color2, 1.6) }};
        --meu-accent: {{$style_color1}};
        --meu-accent-light: {{$style_color4}};
        --meu-accent-dark: {{ Helper::colorHexToDarken($style_color1, 1.2) }};
        --meu-cream: {{$style_color3}};
