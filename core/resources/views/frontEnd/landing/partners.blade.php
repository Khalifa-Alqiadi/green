...
@if(count($BlockTopics) >0)
    <section id="landing-block-{{ @$TopicBlock->id }}" class="partners landing-block meu-band-navy {{ @$TopicBlock->css_classes  }}" style="{{ $block_style }}">
        <div class="container">
            ...
            <div class="partners-slider swiper meu-reveal meu-reveal-scale" data-aos="fade-up" data-aos-delay="100">
