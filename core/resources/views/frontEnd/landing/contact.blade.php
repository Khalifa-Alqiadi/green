...
<section id="landing-block-{{ @$TopicBlock->id }}" class="landing-block {{ @$TopicBlock->css_classes  }}" style="{{ $block_style }}">
    <div class="container">
        <div class="meu-contact-split">
            <!-- Contact Information -->
            <div class="meu-contact-info meu-reveal meu-reveal-left">
                @if(@$TopicBlock->title_status)
                    <h3>{{ @$TopicBlockContents->{"title_".@Helper::currentLanguage()->code} }}</h3>
                @endif
                @if(@$TopicBlock->desc_status)
                    <p class="lead-text">{!! nl2br(@$TopicBlockContents->{"desc_".@Helper::currentLanguage()->code}) !!}</p>
                @endif
            ...
            <!-- Contact Form -->
            <div class="meu-contact-form-panel meu-reveal meu-reveal-right">
