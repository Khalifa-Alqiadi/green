...
<section id="landing-block-{{ @$TopicBlock->id }}" class="landing-block {{ @$TopicBlock->css_classes  }}" style="{{ $block_style }}">
    <div class="container">
        ...
        @endif
        <div class="meu-form-card meu-reveal meu-reveal-scale">
            <div class="meu-form-card-head">
                <i class="fa-solid fa-paper-plane"></i> {{ __('frontend.getInTouch') }}
            </div>
            <div class="meu-form-card-body">
